          ...
          <article className={styles.leftColumn}>
            <section className={styles.contactTextContainer}>
              <div className={styles.contactHeadingContainer}>
                ...
                <div className={styles.contactHeadingAccent} />
              </div>
              <p className={styles.contactText}>
                Vi gör det enkelt att få hjälp. Kontakta oss på det sätt som
                passar dig bäst, så hör vi av oss så snart som möjligt.
              </p>
            </section>
